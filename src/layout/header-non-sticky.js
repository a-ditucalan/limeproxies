...
export default class Header extends Component {
  ...
  render() {
    const { email } = this.state;
    return (
      <header className="non-sticky header">
          ...
          <div className="header_wrap__left" onMouseLeave={this.falsifyAllDropdown}>
            ...
            <nav className="header_wrap__menu">
              <ul>
                ...
                <li><Link className="platform_nav_link about-style" to="/pricing" onMouseEnter={this.state.hoverable ? this.falsifyAllDropdown : null} onClick={this.state.hoverable ? null : this.falsifyAllDropdown}>Pricing</Link></li>
                ...
                <li className="platform_nav has_children">
                  <div className="platform_nav_link about-style" onMouseEnter={this.state.hoverable ? this.toggleResourcesDropdown : null} onClick={this.state.hoverable ? null : this.toggleResourcesDropdown}>
                    <Link to="/resources">Resources</Link> <FontAwesomeIcon icon={ faCaretDown }/>
                  </div>
                    ...
                    <div>
                      <div className="sub_menu__item">
                        <ul>
                          ...
                          <li><Link to="/resources/videos">Videos</Link></li>
                ...
                <li className="platform_nav has_children">
                  ...
                  <Link to="/support">Support</Link>  <FontAwesomeIcon icon={faCaretDown }/>
                  </div>
                ...
                <li><Link className="platform_nav_link about-style" to="/get-a-demo" onMouseEnter={this.state.hoverable ? this.falsifyAllDropdown : null} onClick={this.state.hoverable ? null : this.falsifyAllDropdown}>Get A Demo</Link></li>
              </ul>
            </nav>
