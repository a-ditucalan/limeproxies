    ...
    return (
      <main className="article">
        <Helmet>
          ...
          <link rel="canonical" href={`${siteUrl}resources/videos${path}`} />
          { 
          ...
          <div className="custom-container article-border resources-content">
            ...
            <div className="video-wrapper">
              <div className="video-container">
                ...
                <YouTubeWave
                  video={post.frontmatter.upload_videos}
                  id="embed_player"
             ...
             {/* <div className="player-placeholder" style={{ 'background-color': '' }} >
                <ImageObserver src={require("../images/icon_play.svg")}  className="player-btn" altString="Play" />
              </div>*/}
            </div>
      ...
      {/*  <section className="article-content">
       ...
       <section className={`article-navigation ${progressPercent >= 100 ? 'active' : 'inactive'} ${ progressPercent >= 160 ? 'footer-range' : ''}`}>
